...
//FUNCION AÑADIDA PARA FUNCIONAR CON SOFTWARESERIAL 
...
class EasyNex {
   ...
   */
	...
	public:
  	//FUNCION AÑADIDA PARA FUNCIONAR CON SOFTWARESERIAL 
  	#if defined(USE_SOFTWARE_SERIAL)
  		EasyNex(SoftwareSerial& serial);//Constructor
  	#else
  		EasyNex(HardwareSerial& serial);//Constructor
  	#endif
    ...
    int readByte();
	  ...
	  //Funciones añadidas por mi - PUBLICO
